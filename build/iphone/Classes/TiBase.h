...
// in simulator we redefine to format for LunchOrDie Developer console
...
{\
	NSString * exceptionName = [@"org.lunchordie." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.lunchordie";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UILunchOrDieNativeItemNone = -1, 
	UILunchOrDieNativeItemSpinner = -2,
	UILunchOrDieNativeItemProgressBar = -3,
	
	UILunchOrDieNativeItemSlider = -4,
	UILunchOrDieNativeItemSwitch = -5,
	UILunchOrDieNativeItemMultiButton = -6,
	UILunchOrDieNativeItemSegmented = -7,
	
	UILunchOrDieNativeItemTextView = -8,
	UILunchOrDieNativeItemTextField = -9,
	UILunchOrDieNativeItemSearchBar = -10,
	
	UILunchOrDieNativeItemPicker = -11,
	UILunchOrDieNativeItemDatePicker = -12,
	
	UILunchOrDieNativeItemInfoLight = -13,
	UILunchOrDieNativeItemInfoDark = -14,
	
	UILunchOrDieNativeItemDisclosure = -15,
	
	UILunchOrDieNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all LunchOrDie instances of
