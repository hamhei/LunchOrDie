...
/**
 The base class for all LunchOrDie modules
 */
...
/**
 LunchOrDie Platform calls this method on startup.
 */
-(void)startup;

/**
 LunchOrDie Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 LunchOrDie Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 LunchOrDie Platform calls this method on resume.
 @param sender The sender of the event.
 */
