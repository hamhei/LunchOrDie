 ...
 * Copyright (c) 2009-2011 by LunchOrDie, Inc. All Rights Reserved.
...
//@interface LunchOrDieObject : NSObject
//@end

@interface LunchOrDieObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[LunchOrDieObject class]])
		{
			for (NSString *key in [[(LunchOrDieObject*)o modules] allKeys])
			{
