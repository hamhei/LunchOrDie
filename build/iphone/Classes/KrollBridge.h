...
@interface LunchOrDieObject : KrollCoverageObject {
#else
@interface LunchOrDieObject : KrollObject {
#endif
@private
...
extern NSString * LunchOrDie$ModuleRequireFormat;
